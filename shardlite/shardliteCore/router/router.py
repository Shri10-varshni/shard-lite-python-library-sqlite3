"""
Main Router implementation for Shardlite.

This module provides the Router class that routes database operations to appropriate shards using the configured sharding strategy.
"""
